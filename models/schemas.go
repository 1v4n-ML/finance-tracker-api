...
type Account struct {
	...
	Color      string             `json:"color,omitempty" bson:"color,omitempty"` // For UI representation
	ClosureDay int                `json:"closure_day,omitempty" bson:"closure_day,omitempty" binding:"omitempty,gte=1,lte=31"`
	PayDay     int                `json:"payday,omitempty" bson:"payday,omitempty" binding:"omitempty,gte=1,lte=31"`
	CreatedAt  time.Time          `json:"created_at" bson:"created_at"`
	UpdatedAt  time.Time          `json:"updated_at" bson:"updated_at"`
}
