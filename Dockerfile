...
# Build the Go app located in the ./cmd directory
...
# - ./cmd targets the package defined in the cmd/ directory (where main.go is)
...
# The binary name '/app/server' matches the '-o /app/server' in the build command
...
# Command to run the executable named 'server'
CMD ["/app/server"]